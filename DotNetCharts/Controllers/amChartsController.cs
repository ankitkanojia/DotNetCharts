...
namespace DotNetCharts.Controllers
{
    public class amChartsController : Controller
    {
        ...
        public ActionResult ChordDiagram()
        {
            return View();
        }

        public ActionResult ChordDiagramAnimated()
        {
            return View();
        }
        ...
        public ActionResult PolarDiagram()
        {
            return View();
        }
        ...
        public ActionResult AnnotatingCharts()
        {
            return View();
        }
        ...
        public ActionResult VennDiagram()
        {
            return View();
        }
